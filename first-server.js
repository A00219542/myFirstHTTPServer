...
var consolere = require('console-remote-client').connect('console.re','80','A00219542_first_server');

//We need a function which handles requests and send response
function handleRequest(request, response){
    response.end('Yes! It Works!! Path Hit: ' + server_ip_address + ":" + server_port + "/" + request.url);
    console.re.log("My server ip address is: " + server_ip_address "My server port id is: " + server_port);
}
//What is a request?
//What is a response?
//What is an object?
